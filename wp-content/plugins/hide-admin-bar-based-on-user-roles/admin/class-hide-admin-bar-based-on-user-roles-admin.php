                        ...
                        <div class="card card-statistics social-card card-default">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-center mb-2 comment">
                                	<strong><?php echo __("5000+ Active Users..",'hide-admin-bar-based-on-user-roles');?></strong><Br />
                                ...
                                <a href="" target="_blank" class="text-center btn btn-info btn-rounded btn-fw"><?php echo __("Download Now",'hide-admin-bar-based-on-user-roles');?></a></small>
                            </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 stretch-card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="https://twitter.com/ankit__panchal" target="_blank" class="text-center btn btn-info btn-rounded btn-fw"><?php echo __("View Profile",'hide-admin-bar-based-on-user-roles');?></a></small>
                            </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 stretch-card">
